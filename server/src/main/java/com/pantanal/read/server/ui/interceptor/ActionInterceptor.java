...
public class ActionInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        /*
        if (!request.getRequestURI().endsWith("/license.do") && !checkLicense(request, response)) {
            response.sendRedirect(request.getContextPath() + "/web/license.do");
            return false;
        }

        String requestUri = request.getRequestURI();
        if (requestUri.endsWith("/userLogin.do") || requestUri.endsWith("/userRegister.do") || requestUri.endsWith("/license.do")
