                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <button type="button" class="btn btn-primary waves-effect waves-light btn-sm m-r-5 autoformat">Autoformat Selected</button>
                                <button type="button" class="btn btn-primary waves-effect waves-light btn-sm m-r-5 comment">Comment Selected</button>
                                <button type="button" class="btn btn-primary waves-effect waves-light btn-sm uncomment">Uncommment Selected</button>
                            </div><!-- panel-heading -->
                            <div class="panel-body code-edit-wrap">
...
<style> .test { font-size: medium; font-family: monospace; }
        ...
        <script src="assets/plugins/codemirror/formatting.js"></script>
        <script src="assets/plugins/codemirror/xml.js"></script>
        <script src="assets/plugins/codemirror/javascript.js"></script>
        <script src="assets/plugins/codemirror/custom.codemirror.js"></script>
