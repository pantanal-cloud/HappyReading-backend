            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Email Read</h4>
                            ...
                            <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="panel-body">
                                        <div class="media m-b-30">
                                            <a href="#" class="media-left">
                                                <img alt="" src="assets/images/users/avatar-2.jpg" class="media-object thumb-sm">
                                            </a>
                                            <div class="media-body">
                                                <span class="media-meta pull-right">07:23 AM</span>
                                                <h4 class="text-primary m-0">Jonathan Smith</h4>
                                                <small class="text-muted">From: jonathan@moltran.com</small>
                                            </div>
                                        </div> <!-- media -->
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="media">
                                            <a href="#" class="media-left">
                                                <img alt="" src="assets/images/users/avatar-9.jpg" class="media-object thumb-sm">
                                            </a>
                                            <div class="media-body">
                                        ...
                                        <div class="text-right">
                                            <button type="button" class="btn btn-primary waves-effect waves-light m-t-30 w-md">Send</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- Replay -->
