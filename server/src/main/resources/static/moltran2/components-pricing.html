            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Pricing Table</h4>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-3">
                                    <div class="price_card text-center">
                                        ...
                                        <button type="button" class="btn btn-primary waves-effect waves-light w-md">Sign Up</button>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="price_card text-center">
                                        ...
                                        <button type="button" class="btn btn-pink w-md waves-effect waves-light">Sign Up</button>
                                    </div>
                                </div> <!-- end col -->
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="price_card text-center">
                                        ...
                                        <button type="button" class="btn btn-purple w-md waves-effect waves-light">Sign Up</button>
                                    </div> <!-- end Pricing_card -->
                                </div> <!-- end col -->
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="price_card text-center">
                                        ...
                                        <button type="button" class="btn btn-success w-md waves-effect waves-light">Sign Up</button>
                                    </div> <!-- end Pricing_card -->
                                </div> <!-- end col -->
                          ...
                          <div class="pricing-item">
                            <div class="pricing-item-inner">
                              <div class="pricing-wrap">     
                                ...
                                <!-- Button -->                     
                                <div class="pr-button">
                                   <button type="button" class="btn btn-warning w-md waves-effect">Sign Up</button>
                                </div>
                              </div>
                            </div>
                          </div>
